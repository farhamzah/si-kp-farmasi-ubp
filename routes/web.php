...
use App\Http\Controllers\Internal\TaEligibilityController;
...
use App\Http\Controllers\Management\PostExamReportController as ManagementPostExamReportController;
...
use App\Http\Controllers\Student\PostExamReportController as StudentPostExamReportController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::middleware('role.selected')->group(function () {
        ...
        Route::middleware('role:admin,koordinator_kp')->prefix('management')->name('management.')->group(function () {
            ...
            Route::get('post-exam-reports', [ManagementPostExamReportController::class, 'index'])->name('post-exam-reports.index');
            Route::get('post-exam-reports/{report}/preview', [ManagementPostExamReportController::class, 'preview'])->name('post-exam-reports.preview');
            Route::get('post-exam-reports/{report}/download', [ManagementPostExamReportController::class, 'download'])->name('post-exam-reports.download');
        ...
        Route::middleware('role:mahasiswa')->prefix('mahasiswa')->name('student.')->group(function () {
            ...
            Route::post('laporan-akhir/dokumen-pascasidang', [StudentPostExamReportController::class, 'store'])->name('post-exam-reports.store');
            Route::get('laporan-akhir/dokumen-pascasidang/preview', [StudentPostExamReportController::class, 'preview'])->name('post-exam-reports.preview');
            Route::get('laporan-akhir/dokumen-pascasidang/download', [StudentPostExamReportController::class, 'download'])->name('post-exam-reports.download');
