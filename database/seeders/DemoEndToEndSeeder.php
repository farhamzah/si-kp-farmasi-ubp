    ...
    private function approvedFinalReport(KpAssignment $assignment, User $reviewer): void
    {
        $report = KpFinalReport::updateOrCreate(
            ...
            [
                ...
                'internal_reviewed_at' => now()->subDay(),
                'internal_review_note' => 'Bimbingan laporan demo pembimbing dalam selesai.',
                'field_review_status' => 'disetujui',
                'field_reviewed_by' => $assignment->fieldSupervisor?->user_id,
                'field_reviewed_at' => now()->subDay(),
                'field_review_note' => 'Bimbingan laporan demo pembimbing lapangan selesai.',
            ]
        );
    ...
    private function completedExam(KpAssignment $assignment, User $studentUser, User $coordinator, Lecturer $supervisor, Lecturer $examiner): KpExam
    {
        $request = KpExamRequest::updateOrCreate(
            ...
            [
                ...
                'payment_proof_review_note' => 'Bukti pembayaran KP demo sudah sesuai.',
                'payment_proof_reviewed_by' => $coordinator->id,
