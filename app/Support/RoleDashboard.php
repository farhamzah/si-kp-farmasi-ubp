...
class RoleDashboard
{
    public const ROLES = [
        'mahasiswa' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Pendaftaran KP', 'Logbook', 'Laporan Akhir', 'Sidang', 'Nilai'],
        ...
        'admin' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Manajemen User', 'Import User', 'Riwayat Import', 'Data Master', 'Verifikasi Berkas', 'Rekap'],
            'features' => ['Manajemen User', 'Import Excel', 'Data Mahasiswa', 'Data Dosen', 'Data Tempat KP', 'Verifikasi Berkas', 'Rekap'],
        ],
        'koordinator_kp' => [
            'label' => 'Koordinator KP',
            'route' => 'koordinator.dashboard',
            'path' => '/koordinator/dashboard',
            'menu' => ['Dashboard', 'Profil Saya', 'Periode KP', 'Tempat dan Kuota', 'Pembimbing', 'Penguji', 'Finalisasi Nilai'],
            'features' => ['Periode KP', 'Tempat dan Kuota', 'Monitoring Pemilihan Tempat', 'Penentuan Pembimbing', 'Penentuan Penguji', 'Finalisasi Nilai'],
        ],
        'pembimbing_dalam' => [
