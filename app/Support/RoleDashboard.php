...
class RoleDashboard
{
    public const ROLES = [
        ...
        'admin' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Manajemen User', 'Import User', 'Riwayat Import', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Report Pembimbing Dalam', 'Log Penempatan', 'Panduan Kompetensi', 'Kuisioner KP', 'Hasil Kuisioner', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Monitoring Laporan', 'Dokumen Pascasidang', 'Log Laporan', 'Pengajuan Sidang', 'Jadwal Sidang', 'Undangan Sidang', 'Log Sidang', 'Komponen Penilaian', 'Monitoring Nilai', 'Hasil Pre/Post Test', 'Log Nilai', 'Rekap KP', 'Review Integrasi'],
        ...
        'pembimbing_dalam' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Mahasiswa Bimbingan', 'Capaian Kompetensi', 'Logbook Mahasiswa', 'Review Laporan', 'Jadwal Sidang', 'Undangan Sidang', 'Penilaian Pembimbing'],
        ...
        'penguji' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Jadwal Sidang', 'Undangan Sidang', 'Penilaian Sidang'],
