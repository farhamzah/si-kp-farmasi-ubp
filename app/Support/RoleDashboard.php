...
class RoleDashboard
{
    public const ROLES = [
        'mahasiswa' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Pendaftaran KP', 'Berkas KP', 'Pemilihan Tempat KP', 'Penempatan KP', 'Logbook', 'Laporan Akhir', 'Sidang', 'Nilai'],
        ...
        'admin' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Manajemen User', 'Import User', 'Riwayat Import', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Rekap'],
        ...
        'koordinator_kp' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Pembimbing', 'Penguji', 'Finalisasi Nilai'],
