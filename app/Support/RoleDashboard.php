...
class RoleDashboard
{
    public const ROLES = [
        ...
        'koordinator_kp' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Monitoring Laporan', 'Log Laporan', 'Pengajuan Sidang', 'Jadwal Sidang', 'Log Sidang', 'Pembimbing', 'Penguji', 'Finalisasi Nilai'],
