...
class RoleDashboard
{
    public const ROLES = [
        'mahasiswa' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Pendaftaran KP', 'Berkas KP', 'Pemilihan Tempat KP', 'Penempatan KP', 'Logbook KP', 'Laporan Akhir', 'Sidang', 'Nilai'],
        ...
        'admin' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Manajemen User', 'Import User', 'Riwayat Import', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Rekap'],
        ...
        'koordinator_kp' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Pembimbing', 'Penguji', 'Finalisasi Nilai'],
        ...
        'pembimbing_dalam' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Mahasiswa Bimbingan', 'Logbook Mahasiswa', 'Review Laporan', 'Jadwal Sidang', 'Penilaian'],
