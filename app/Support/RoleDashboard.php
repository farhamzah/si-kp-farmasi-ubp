...
class RoleDashboard
{
    public const ROLES = [
        ...
        'admin' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Manajemen User', 'Import User', 'Riwayat Import', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Monitoring Laporan', 'Log Laporan', 'Pengajuan Sidang', 'Jadwal Sidang', 'Log Sidang', 'Komponen Penilaian', 'Monitoring Nilai', 'Log Nilai', 'Rekap'],
        ...
        'koordinator_kp' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Periode KP', 'Tempat KP', 'Kuota Tempat KP', 'Log Kuota', 'Persyaratan Dokumen', 'Verifikasi Pendaftaran', 'Monitoring Pemilihan', 'Daftar Tunggu', 'Log Pemilihan', 'Penempatan KP', 'Log Penempatan', 'Monitoring Logbook', 'Log Aktivitas Logbook', 'Monitoring Laporan', 'Log Laporan', 'Pengajuan Sidang', 'Jadwal Sidang', 'Log Sidang', 'Komponen Penilaian', 'Monitoring Nilai', 'Log Nilai'],
        ...
        'pembimbing_dalam' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Mahasiswa Bimbingan', 'Logbook Mahasiswa', 'Review Laporan', 'Jadwal Sidang', 'Penilaian Pembimbing'],
