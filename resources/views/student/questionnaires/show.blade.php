...
<form method="POST" action="{{ route('student.questionnaires.submit', $questionnaire) }}" class="space-y-5">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <a href="{{ route('student.questionnaires.index') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-black text-slate-700">Kembali ke Kuisioner</a>
