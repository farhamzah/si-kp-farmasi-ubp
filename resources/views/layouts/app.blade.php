            ...
            @foreach(($roleData['menu'] ?? ['Dashboard', 'Profil Saya']) as $item)
                @php
                    ...
                    $routeMap = [
                        ...
                        'Report Pembimbing Dalam' => 'management.internal-supervisor-workload.index',
                        'Log Penempatan' => 'management.kp-assignment-logs.index',
                        'Panduan Kompetensi' => 'management.competencies.index',
                        'Kuisioner KP' => $activeRole === 'mahasiswa' ? 'student.questionnaires.index' : 'management.questionnaires.index',
                        'Hasil Kuisioner' => 'management.questionnaire-results.index',
                        ...
                        'Kuisioner Tempat KP' => 'field-supervisor.questionnaires.index',
                        ...
                        'Review Laporan' => $activeRole === 'pembimbing_lapangan' ? 'field-supervisor.final-reports.index' : 'internal-supervisor.final-reports.index',
                        'Monitoring Laporan' => 'management.final-reports.index',
                        'Dokumen Pascasidang' => 'management.post-exam-reports.index',
                        ...
                        'Undangan Sidang' => 'exam-invitations.index',
                    ...
                    $activeMap = [
                        ...
                        'Report Pembimbing Dalam' => ['management.internal-supervisor-workload.*'],
                        ...
                        'Kuisioner KP' => ['management.questionnaires.*', 'student.questionnaires.*'],
                        'Hasil Kuisioner' => ['management.questionnaire-results.*'],
                        ...
                        'Kuisioner Tempat KP' => ['field-supervisor.questionnaires.*'],
                        ...
                        'Review Laporan' => ['internal-supervisor.final-reports.*', 'field-supervisor.final-reports.*'],
                        'Monitoring Laporan' => ['management.final-reports.*'],
                        'Dokumen Pascasidang' => ['management.post-exam-reports.*'],
                        ...
                        'Undangan Sidang' => ['exam-invitations.*'],
