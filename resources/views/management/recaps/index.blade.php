...
<div class="space-y-6">
    <section class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
        ...
        <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500">Gunakan halaman ini untuk membaca ringkasan progres KP dan mengunduh data penting dalam format Excel.</p>
    </section>
        ...
        @foreach([
            ...
            <article class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('management.exports.download', $type) }}" class="rounded-2xl bg-cyan-700 px-3 py-2 text-xs font-bold text-white">Export</a>
                </div>
            </article>
        @endforeach
    </section>
