...
<div class="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
    ...
    <div class="grid gap-2 sm:grid-cols-2 lg:flex lg:flex-wrap">
        <a href="{{ route('management.internal-supervisor-workload.index') }}" class="inline-flex min-h-11 items-center justify-center rounded-lg border border-cyan-200 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-800">Report Pembimbing Dalam</a>
